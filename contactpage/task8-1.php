      ...
      <form action="task8-1.php" method="post" name="name" onsubmit="return vaildate()">
        ...
        <div class="item">
          ...
          <div class="input">
            <div class="input_border">
              <div class="input_text">
                <input type="text" name="furigana" placeholder="ヤマダタロウ" value="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="input">
            <div class="input_border">
              <div class="input_text">
                <input type="text" name="email" placeholder="info@fast-creademy.jp" value="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="input">
            <div class="input_border">
              <div class="input_text">
                <input type="text" name="tel" placeholder="info@fast-creademy.jp" value="">
              </div>
            </div>
          </div>
        </div>
